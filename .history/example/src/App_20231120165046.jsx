...
function haversine_deg(theta) {
    return (1 - Math.cos(theta * Math.PI / 180))
}

function calcDistance2(lat, lng) {
    const h = haversine_deg()
}

function calcDistance() {
    // Miami
    let p1 = Cartesian3.fromDegrees(25.7617, -80.1918)
    // Tokyo
    let p2 = Cartesian3.fromDegrees(35.6897, 139.6922)
